...
<?php
$sql="SELECT * FROM `contents` where userId=".$user_data['id']."";
...
<button id="like-content-button-js" data-post-id=<?php echo $row['id']; ?>><?php 
    ...
    $data=queryResult($functionSql,$conn);
     ...
     ?></button>
<button name="deleteContentButton"  id="delete-content-button-js" data-post-id=<?php echo $row['id']; ?> >delete<?php
?>
</button>
</div>
...
?>
        ...
        <script src="../scripts/box-3.js" type="module" ></script>
        <script src="../scripts/generateCommonHtmlForAllPage.js" type="module" ></script>
        <script>
        $(document).ready(()=>{
